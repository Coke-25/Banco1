...
public class TestBanco {
	public static void main(String[] args) {
		...
		System.out.println("La cuenta de " + cuentaAntonio.getNombreCliente().getNombre() + " tiene "
				+ cuentaAntonio.getSaldo() + " euros.");
		System.out.println("La cuenta de " + cuentaBeatriz.getNombreCliente().getNombre() + " tiene "
